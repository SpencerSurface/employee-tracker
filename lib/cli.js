...
class CLI {
    ...
    updateEmployeeManager() {
        ...
        let employeeId;
        // Prompt the user for the employee, get the employee's id
        promptForId(this.db, "employee_id", "CONCAT(first_name, ' ', last_name)", "employee_name", "employees", "Which employee's manager do you want to update?")
        .then((id) => {
            // Store the employee's id
            employeeId = id;
    ...
    viewEmployeesByManager() {
        ...
        promptForId(this.db, "employee_id", "CONCAT(first_name, ' ', last_name)", "employee_name", "employees", "Which manager's employees do you want to view?")
        .then((managerId) => {
